"""
Django settings for ani_repo project.
...
#for login purposes
# LOGIN_URL = '/login/'
#LOGIN_REDIRECT_URL = '/animesdashboard/' #the "next" url. Redirects to login page when logged out
...
SECRET_KEY = 'django-insecure-8ilql=e284izvjlp^c@oh(vk70^k(5j(wk9szk%n*wwez@%-7$'
